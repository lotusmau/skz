...
function pickNext() {
    ...
    document.getElementById("quiz-clue").textContent = nicknames[currentIndex];
...
function handleGuess(e) {
    ...
    if (correct) {
        score++;
        feedback.textContent = "Correct! " + nicknames[currentIndex] + " is " + members[currentIndex] + "!";
        feedback.className = "feedback correct";
    } else {
        feedback.textContent = "Nope! " + nicknames[currentIndex] + " is " + members[currentIndex] + ".";
